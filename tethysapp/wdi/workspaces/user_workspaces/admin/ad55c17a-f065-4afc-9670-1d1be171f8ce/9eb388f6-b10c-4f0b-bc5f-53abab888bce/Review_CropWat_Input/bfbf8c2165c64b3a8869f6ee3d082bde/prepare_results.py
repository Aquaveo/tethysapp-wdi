...
from adhparam.model_control import ModelControl
from tethysext.atcore.services.file_database import FileCollectionClient, FileDatabaseClient

from steem_adapter.models.resources import DatasetResource
from steem_adapter.models.resources.model_resource import ModelResource
from steem_adapter.model_interfaces.adh.helpers import calculate_area, get_node_location
from steem_adapter.model_interfaces.adh.spatial_builder import AdhModelSpatialBuilder

# DO NOT REMOVE, need to import all the subclasses of ResourceWorkflowStep for the polymorphism to work.
from steem_adapter.models.app_users.organization import SteemOrganization  # noqa: F401, F403
...
def main(resource_db_session, model_db_session, resource, workflow, step, gs_private_url, gs_public_url, resource_class,
    ...
    existing_model = resource_db_session.query(ModelResource).get(existing_model_id)
