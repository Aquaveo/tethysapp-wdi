...
To run any tests:
    ...
    4. Enter tethys test command.
       The general form is: "tethys test -f
       tethys_apps.tethysapp.<app_name>.<folder_name>.<file_name>.<class_name>.<function_name>"
       See below for specific examples

        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.wdi"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.wdi.tests.tests"

        To run tests in the WdiTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.wdi.tests.tests.WdiTestCase"

        To run only the test_if_tethys_platform_is_great function in the WdiTestCase class:
            Test command: "tethys test -f
            tethys_apps.tethysapp.wdi.tests.tests.WdiTestCase.test_if_tethys_platform_is_great"
...
class WdiTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(Wdi)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(Wdi)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/wdi/')  # The final '/' is essential for all pages/controllers
